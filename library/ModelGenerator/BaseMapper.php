...
class ModelGenerator_BaseMapper
{
    ...
    public function generate()
    {
                     ...
                     'docblock'   => new Zend_CodeGenerator_Php_Docblock(
                         array(
                              'tags' => array(
                                  ...
                                  array(
                                      'name'        => 'return',
                                      'description' => $this->_getNamer()->formatClassName($this->_config->classname)
                                  ),
                              ),
                         )),
                     'parameters' => array(
        ...
        $modelTableBase = new Zend_CodeGenerator_Php_Class(
            array(
                 'name'          => $className,
                 'docblock'      => new Zend_CodeGenerator_Php_Docblock(
                     array(
                 ...
                 'properties'    => array(
                     ...
                     array(
                         'name'         => '_primary',
                         'visiblity'    => 'protected',
                         'defaultValue' => $table->getPrimary()
                     ),
                     array(
                         'name'         => '_dependantTables',
                         'visiblity'    => 'protected',
                         'defaultValue' => $table->getDependantTables()
                     ),
                 ),
                 'methods'       => $methods,
            ));

        $modelTableBaseFile = new Zend_CodeGenerator_Php_File(
            array(
